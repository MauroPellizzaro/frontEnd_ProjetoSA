 ...
 */
public class Converter_temperatura extends javax.swing.JFrame {

    /**
     * Creates new form Converter_temperatura
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Conversor de Celcius para Kelvin");

        Txt_celcius.setText("Celcius");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //Celcius recebe a corversão para floar da captação do texto Txt_celcius
        celcius = Float.parseFloat(Txt_celcius.getText());
        kelvin = celcius+273;
        
        //Mostra a mensagem com o cálculo feito
        JOptionPane.showMessageDialog(null, kelvin);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Converter_temperatura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Converter_temperatura().setVisible(true);
            }
        });
    }
